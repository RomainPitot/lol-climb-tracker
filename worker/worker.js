 ...
 * Secrets requis : RIOT_API_KEY (ta clé Riot — une Personal API Key Riot n'expire pas,
 * contrairement à une clé de dev qu'il faut renouveler ici à la main toutes les 24h),
 * PROXY_TOKEN (une chaîne aléatoire).
 */
export default {
